let followersCardContainer = document.querySelector(".followers_cards");
...
fetch(
  ...
  `;
        ...
        followersCardContainer.innerHTML = ` <h3 id="no_followers">No Followers</h3>`
      }
    ...
    followersURL = data.items[0].followers_url;
    fetch(followersURL)
      .then((response) => response.json())
      .then((followers) => {
        ...
        followers.forEach((follower) => {
          ...
          followersCardContainer.innerHTML += `
                <div class="col-9">
          <div
